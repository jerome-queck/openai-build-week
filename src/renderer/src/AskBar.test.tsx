...
function questionSession(): LearningSession {
  ...
  return {
    ...
    teachingMoves: [{ id: "move-1", kind: "explain", route: "proofStructural", reason: "Use the source", evidenceIds: [], experimentId: null }],
    currentTeachingMove: { id: "move-1", kind: "explain", route: "proofStructural", reason: "Use the source", evidenceIds: [], experimentId: null },
